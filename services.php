...
<div class="grid-3" id="servicesGrid">
    ...
    <div class="interactive-card">
        ...
        <p>
            Student registration, enrollment verification,
            student ID cards, and academic calendar support.
             
        </p>
        <br>
        <a href="registration-services.php" class="btn">read more</a>
        <div class="card-meta">
            Registrar Office
        </div>
    </div>
    ...
    <div class="interactive-card">
        ...
        <p>
            ...
            study planning and student success support.
        </p>
        <br>
        <a href="academic-advising-counseling.php" class="service-btn">
    Learn More
</a>
        <div class="card-meta">
    ...
    <div class="interactive-card">
        ...
        <p>
            Scholarship opportunities, sponsorship information,
            tuition support and financial assistance.
        </p>
        <br>
        <a href="scholarships-financial-support.php" class="service-btn">
    Learn More
</a>
        <div class="card-meta">
            Finance & Scholarship Office
        </div>
    </div>
